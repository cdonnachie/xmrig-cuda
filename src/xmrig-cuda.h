...
XMRIG_EXPORT bool meowPowHash(nvid_ctx *ctx, uint8_t* job_blob, uint64_t target, uint32_t *rescount, uint32_t *resnonce, uint32_t *skipped_hashes);
XMRIG_EXPORT bool meowPowPrepare_v2(nvid_ctx *ctx, const void* cache, size_t cache_size, const void* dag_precalc, size_t dag_size, uint32_t height, const uint64_t* dag_sizes);
XMRIG_EXPORT bool meowPowStopHash(nvid_ctx *ctx);
XMRIG_EXPORT bool evrProgPowHash(nvid_ctx *ctx, uint8_t* job_blob, uint64_t target, uint32_t *rescount, uint32_t *resnonce, uint32_t *skipped_hashes);
XMRIG_EXPORT bool evrProgPowPrepare_v2(nvid_ctx *ctx, const void* cache, size_t cache_size, const void* dag_precalc, size_t dag_size, uint32_t height, const uint64_t* dag_sizes);
XMRIG_EXPORT bool evrProgPowStopHash(nvid_ctx *ctx);
XMRIG_EXPORT bool merakiHash(nvid_ctx *ctx, uint8_t* job_blob, uint64_t target, uint32_t *rescount, uint32_t *resnonce, uint32_t *skipped_hashes);
XMRIG_EXPORT bool merakiPrepare_v2(nvid_ctx *ctx, const void* cache, size_t cache_size, const void* dag_precalc, size_t dag_size, uint32_t height, const uint64_t* dag_sizes);
XMRIG_EXPORT bool merakiStopHash(nvid_ctx *ctx);
