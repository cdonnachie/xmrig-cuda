...
__device__ __forceinline__ uint4 fnv4(uint4 a, uint4 b)
{
	uint4 c;
...
__global__ void evrprogpow_calculate_dag_item(uint32_t start, hash64_t *g_dag, uint64_t dag_bytes, hash64_t* g_light, uint4 light_words)
{
